...
SIGNAL \dut_instance|add_instance|dff20|Q~q\ : std_logic;
SIGNAL \dut_instance|add_instance|D[1]~0_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|dff10|Q~q\ : std_logic;
SIGNAL \dut_instance|add_instance|dff00|Q~q\ : std_logic;
...
SIGNAL \dut_instance|add_instance|dff00|ALT_INV_Q~q\ : std_logic;
...
\dut_instance|add_instance|dff00|ALT_INV_Q~q\ <= NOT \dut_instance|add_instance|dff00|Q~q\;
...
-- pragma translate_on
PORT MAP (
	i => \dut_instance|add_instance|dff00|ALT_INV_Q~q\,
	devoe => ww_devoe,
	o => ww_state_out(0));
...
-- Equation(s):
-- \datau[0]~1_combout\ = (\datau[0]~0_combout\ & (!\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\ & ((!\dut_instance|add_instance|dff00|Q~q\)))) # (!\datau[0]~0_combout\ & (((datau(0)))))
...
PORT MAP (
	...
	datac => datau(0),
	datad => \dut_instance|add_instance|dff00|Q~q\,
...
-- Equation(s):
-- \dut_instance|add_instance|D\(2) = (\dut_instance|add_instance|dff10|Q~q\ & (!\dut_instance|add_instance|dff20|Q~q\ & \dut_instance|add_instance|dff00|Q~q\)) # (!\dut_instance|add_instance|dff10|Q~q\ & (\dut_instance|add_instance|dff20|Q~q\))
...
-- pragma translate_on
PORT MAP (
	dataa => \dut_instance|add_instance|dff10|Q~q\,
	datac => \dut_instance|add_instance|dff20|Q~q\,
	datad => \dut_instance|add_instance|dff00|Q~q\,
...
\dut_instance|add_instance|dff20|Q\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \dut_instance|add_instance|dff20|Q~q\);

-- Location: LCCOMB_X33_Y27_N10
\dut_instance|add_instance|D[1]~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|D[1]~0_combout\ = (!\dut_instance|add_instance|dff00|Q~q\ & ((!\dut_instance|add_instance|dff10|Q~q\) # (!\dut_instance|add_instance|dff20|Q~q\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \dut_instance|add_instance|dff20|Q~q\,
	datac => \dut_instance|add_instance|dff10|Q~q\,
	datad => \dut_instance|add_instance|dff00|Q~q\,
	combout => \dut_instance|add_instance|D[1]~0_combout\);

-- Location: FF_X33_Y27_N11
\dut_instance|add_instance|dff10|Q\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \dut_instance|add_instance|dff10|Q~q\);

-- Location: LCCOMB_X33_Y27_N0
\dut_instance|add_instance|D[0]\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|D\(0) = (\dut_instance|add_instance|dff10|Q~q\ & !\dut_instance|add_instance|dff20|Q~q\)
...
PORT MAP (
	dataa => \dut_instance|add_instance|dff10|Q~q\,
	datad => \dut_instance|add_instance|dff20|Q~q\,
	combout => \dut_instance|add_instance|D\(0));

-- Location: FF_X33_Y27_N1
\dut_instance|add_instance|dff00|Q\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \dut_instance|add_instance|dff00|Q~q\);
