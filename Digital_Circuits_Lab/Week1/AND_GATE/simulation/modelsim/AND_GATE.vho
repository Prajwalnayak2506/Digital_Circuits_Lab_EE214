...
SIGNAL \add_instance|NOR3|Y~0_combout\ : std_logic;
SIGNAL \add_instance|NOR3|ALT_INV_Y~0_combout\ : std_logic;
...
\add_instance|NOR3|ALT_INV_Y~0_combout\ <= NOT \add_instance|NOR3|Y~0_combout\;
...
-- pragma translate_on
PORT MAP (
	i => \add_instance|NOR3|ALT_INV_Y~0_combout\,
	devoe => ww_devoe,
...
\add_instance|NOR3|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|NOR3|Y~0_combout\ = (!\input_vector[0]~input_o\) # (!\input_vector[1]~input_o\)
...
PORT MAP (
	...
	combout => \add_instance|NOR3|Y~0_combout\);
