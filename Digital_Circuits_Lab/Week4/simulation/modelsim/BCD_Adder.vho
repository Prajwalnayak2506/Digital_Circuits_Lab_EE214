...
-- state_out[2]	=>  Location: PIN_12,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \dut_instance|add_instance|FourBitAdder|FULLADDER1|XOR2|Y~0_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|FourBitAdder|FULLADDER1|OR2|Y~0_combout\ : std_logic;
SIGNAL \datau[2]~6_combout\ : std_logic;
SIGNAL \datau[2]~7_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|FourBitAdder|FULLADDER2|OR2|Y~0_combout\ : std_logic;
...
-- pragma translate_on
PORT MAP (
	i => \dut_instance|add_instance|OR2|Y~0_combout\,
	devoe => ww_devoe,
	o => ww_state_out(0));
...
\dut_instance|add_instance|FourBitAdder|FULLADDER1|XOR2|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|FourBitAdder|FULLADDER1|XOR2|Y~0_combout\ = dut_input(1) $ (dut_input(5) $ (((dut_input(4) & dut_input(0)))))
...
PORT MAP (
	...
	datac => dut_input(4),
	datad => dut_input(0),
	combout => \dut_instance|add_instance|FourBitAdder|FULLADDER1|XOR2|Y~0_combout\);

-- Location: LCCOMB_X28_Y24_N24
\dut_instance|add_instance|FourBitAdder|FULLADDER1|OR2|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|FourBitAdder|FULLADDER1|OR2|Y~0_combout\ = (dut_input(5) & ((dut_input(1)) # ((dut_input(4) & dut_input(0))))) # (!dut_input(5) & (dut_input(4) & (dut_input(1) & dut_input(0))))
...
PORT MAP (
	...
	datac => dut_input(1),
	datad => dut_input(0),
	combout => \dut_instance|add_instance|FourBitAdder|FULLADDER1|OR2|Y~0_combout\);
...
-- Equation(s):
-- \datau[2]~6_combout\ = dut_input(2) $ (\dut_instance|add_instance|FourBitAdder|FULLADDER1|OR2|Y~0_combout\ $ (dut_input(6)))
...
PORT MAP (
	dataa => dut_input(2),
	datab => \dut_instance|add_instance|FourBitAdder|FULLADDER1|OR2|Y~0_combout\,
	datad => dut_input(6),
...
-- Equation(s):
-- \datau[2]~7_combout\ = (\dut_instance|add_instance|OR2|Y~0_combout\ & ((\datau[2]~2_combout\) # ((\dut_instance|add_instance|FourBitAdder|FULLADDER1|XOR2|Y~0_combout\ & \datau[2]~6_combout\)))) # (!\dut_instance|add_instance|OR2|Y~0_combout\ & 
-- (((\datau[2]~6_combout\))))
...
PORT MAP (
	...
	datab => \dut_instance|add_instance|OR2|Y~0_combout\,
	datac => \dut_instance|add_instance|FourBitAdder|FULLADDER1|XOR2|Y~0_combout\,
...
\dut_instance|add_instance|FourBitAdder|FULLADDER2|OR2|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|FourBitAdder|FULLADDER2|OR2|Y~0_combout\ = (\dut_instance|add_instance|FourBitAdder|FULLADDER1|OR2|Y~0_combout\ & ((dut_input(2)) # (dut_input(6)))) # (!\dut_instance|add_instance|FourBitAdder|FULLADDER1|OR2|Y~0_combout\ & 
...
PORT MAP (
	...
	datac => dut_input(2),
	datad => dut_input(6),
	combout => \dut_instance|add_instance|FourBitAdder|FULLADDER2|OR2|Y~0_combout\);

-- Location: LCCOMB_X28_Y24_N2
\datau[3]~11\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \datau[3]~11_combout\ = (dut_input(7) & (\dut_instance|add_instance|FourBitAdder|FULLADDER2|OR2|Y~0_combout\ $ (((\datau[2]~2_combout\))))) # (!dut_input(7) & ((\dut_instance|add_instance|FourBitAdder|FULLADDER2|OR2|Y~0_combout\ & 
-- ((\datau[2]~2_combout\))) # (!\dut_instance|add_instance|FourBitAdder|FULLADDER2|OR2|Y~0_combout\ & (dut_input(3) & !\datau[2]~2_combout\))))
...
PORT MAP (
	dataa => dut_input(7),
	datab => \dut_instance|add_instance|FourBitAdder|FULLADDER2|OR2|Y~0_combout\,
	datac => dut_input(3),
...
-- Equation(s):
-- \datau[4]~10_combout\ = (\shift_reg~1_combout\ & (\dut_instance|add_instance|OR2|Y~0_combout\)) # (!\shift_reg~1_combout\ & (((datau(4) & !\shift_reg~3_combout\))))
...
-- Equation(s):
-- \datau[1]~5_combout\ = (\shift_reg~1_combout\ & (\dut_instance|add_instance|OR2|Y~0_combout\ $ ((\dut_instance|add_instance|FourBitAdder|FULLADDER1|XOR2|Y~0_combout\)))) # (!\shift_reg~1_combout\ & (((datau(2)))))
...
-- Equation(s):
-- \datau[2]~2_combout\ = (!\dut_instance|add_instance|FourBitAdder|FULLADDER1|XOR2|Y~0_combout\ & (dut_input(2) $ (\dut_instance|add_instance|FourBitAdder|FULLADDER1|OR2|Y~0_combout\ $ (!dut_input(6)))))
...
PORT MAP (
	...
	datab => \dut_instance|add_instance|FourBitAdder|FULLADDER1|OR2|Y~0_combout\,
	datac => dut_input(6),
	datad => \dut_instance|add_instance|FourBitAdder|FULLADDER1|XOR2|Y~0_combout\,
	combout => \datau[2]~2_combout\);

-- Location: LCCOMB_X28_Y24_N6
\dut_instance|add_instance|OR2|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|OR2|Y~0_combout\ = (\datau[2]~2_combout\ & ((\dut_instance|add_instance|FourBitAdder|FULLADDER2|OR2|Y~0_combout\ & ((dut_input(7)) # (dut_input(3)))) # (!\dut_instance|add_instance|FourBitAdder|FULLADDER2|OR2|Y~0_combout\ & 
-- (dut_input(7) & dut_input(3))))) # (!\datau[2]~2_combout\ & ((\dut_instance|add_instance|FourBitAdder|FULLADDER2|OR2|Y~0_combout\) # ((dut_input(7)) # (dut_input(3)))))
