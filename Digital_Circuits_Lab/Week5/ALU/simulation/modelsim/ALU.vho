...
-- state_out[0]	=>  Location: PIN_89,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \dut_instance|add_instance|Equal1~0_combout\ = (dut_input(0) & (dut_input(4) & (dut_input(5) $ (!dut_input(1))))) # (!dut_input(0) & (!dut_input(4) & (dut_input(5) $ (!dut_input(1)))))
...
-- Equation(s):
-- \dut_instance|add_instance|Equal1~1_combout\ = (dut_input(3) & (dut_input(7) & (dut_input(2) $ (!dut_input(6))))) # (!dut_input(3) & (!dut_input(7) & (dut_input(2) $ (!dut_input(6)))))
...
-- Equation(s):
-- \datau[0]~2_combout\ = (\dut_instance|add_instance|Equal1~1_combout\ & (\dut_instance|add_instance|Equal1~0_combout\ $ (!dut_input(3))))
...
-- Equation(s):
-- \datau[0]~1_combout\ = (dut_input(7) & ((dut_input(6) $ (dut_input(2))) # (!\dut_instance|add_instance|Equal1~0_combout\))) # (!dut_input(7) & (dut_input(6) & ((!dut_input(2)))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0111101100001010",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => dut_input(6),
...
-- Equation(s):
-- \datau[0]~0_combout\ = (dut_input(1) & (!dut_input(0) & (dut_input(5) & dut_input(4)))) # (!dut_input(1) & ((dut_input(5)) # ((!dut_input(0) & dut_input(4)))))
...
-- Equation(s):
-- \datau[0]~3_combout\ = (dut_input(3) & (\datau[0]~2_combout\)) # (!dut_input(3) & ((\datau[0]~1_combout\) # ((\datau[0]~2_combout\ & \datau[0]~0_combout\))))
...
-- Equation(s):
-- \datau[0]~4_combout\ = (dut_input(4) & ((\datau[0]~3_combout\ & ((dut_input(7)) # (!dut_input(3)))) # (!\datau[0]~3_combout\ & (!dut_input(3) & dut_input(7))))) # (!dut_input(4) & ((dut_input(3) $ (dut_input(7)))))
...
-- Equation(s):
-- \datau[0]~5_combout\ = (!dut_input(3) & (((dut_input(7)) # (!\dut_instance|add_instance|Equal1~1_combout\)) # (!\dut_instance|add_instance|Equal1~0_combout\)))
...
-- Equation(s):
-- \datau[0]~6_combout\ = (\datau[0]~5_combout\ & ((dut_input(3) $ (dut_input(7))) # (!\datau[0]~3_combout\)))
...
-- Equation(s):
-- \datau[0]~7_combout\ = (\datau[0]~6_combout\ & (dut_input(0) & ((dut_input(4)) # (!\datau[0]~4_combout\)))) # (!\datau[0]~6_combout\ & (\datau[0]~4_combout\))
...
-- Equation(s):
-- \datau[1]~10_combout\ = (dut_input(3) & ((dut_input(5) & (\datau[0]~3_combout\ & dut_input(7))) # (!dut_input(5) & ((!dut_input(7)))))) # (!dut_input(3) & ((dut_input(7)) # ((\datau[0]~3_combout\ & dut_input(5)))))
...
-- Equation(s):
-- \datau[1]~11_combout\ = (\datau[0]~6_combout\ & (dut_input(1) & ((dut_input(5)) # (!\datau[1]~10_combout\)))) # (!\datau[0]~6_combout\ & (\datau[1]~10_combout\))
...
-- Equation(s):
-- \shift_reg~0_combout\ = (\io~q\ & (!\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\ & \u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_cdr~0_combout\))
...
-- Equation(s):
-- \datau[2]~13_combout\ = (dut_input(6) & ((\datau[0]~3_combout\ & ((dut_input(7)) # (!dut_input(3)))) # (!\datau[0]~3_combout\ & (!dut_input(3) & dut_input(7))))) # (!dut_input(6) & ((dut_input(3) $ (dut_input(7)))))
...
-- Equation(s):
-- \datau[2]~14_combout\ = (\datau[0]~6_combout\ & (dut_input(2) & ((dut_input(6)) # (!\datau[2]~13_combout\)))) # (!\datau[0]~6_combout\ & (\datau[2]~13_combout\))
...
-- Equation(s):
-- \datau[3]~16_combout\ = (dut_input(3) & (((\dut_instance|add_instance|Equal1~0_combout\ & \dut_instance|add_instance|Equal1~1_combout\)) # (!dut_input(7))))
...
PORT MAP (
	...
	datab => \dut_instance|add_instance|Equal1~1_combout\,
	datac => dut_input(3),
	datad => dut_input(7),
...
-- Equation(s):
-- \datau[3]~17_combout\ = (\shift_reg~0_combout\ & (\datau[3]~16_combout\)) # (!\shift_reg~0_combout\ & (((!\shift_reg~3_combout\ & datau(3)))))
...
-- Equation(s):
-- \datau[2]~15_combout\ = (\shift_reg~0_combout\ & (\datau[2]~14_combout\)) # (!\shift_reg~0_combout\ & ((datau(3))))
...
-- Equation(s):
-- \datau[1]~12_combout\ = (\shift_reg~0_combout\ & (\datau[1]~11_combout\)) # (!\shift_reg~0_combout\ & ((datau(2))))
